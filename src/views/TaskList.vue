      ...
      <div class="space-y-6">
        ...
        >
          ...
          <div class="grid grid-cols-2 gap-y-2 gap-x-6 mb-4">
            ...
            <p v-if="task.frequency === 'Once'"><span class="font-semibold">Date:</span> {{ new Date(task.startTime).toLocaleDateString() }} </p>
            <p v-if="task.frequency !== 'Once'"><span class="font-semibold">Start Date:</span> {{ new Date(task.startTime).toLocaleDateString() }} </p>
            <p v-if="task.frequency !== 'Once'"><span class="font-semibold">End Date:</span> {{ new Date(task.endTime).toLocaleDateString() }} </p>
